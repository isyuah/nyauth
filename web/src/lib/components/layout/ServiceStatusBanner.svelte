...
{#if visible}
  <aside class="relative z-[70] flex min-h-11 items-center justify-center gap-3 border-b border-nya-warning/25 bg-nya-warning-soft px-4 py-2 text-small text-nya-warning" role="status" aria-live="polite">

...
type ExternalProvider struct {
	...
	ImportAvatar       bool              `json:"import_avatar" db:"import_avatar"`
	AvatarAllowedHosts []string          `json:"avatar_allowed_hosts" db:"avatar_allowed_hosts"`
...
type CreateProviderRequest struct {
	...
	AvatarAllowedHosts []string `json:"avatar_allowed_hosts,omitempty"`
...
type UpdateProviderRequest struct {
	...
	ImportAvatar       *bool     `json:"import_avatar,omitempty"`
	AvatarAllowedHosts *[]string `json:"avatar_allowed_hosts,omitempty"`
}

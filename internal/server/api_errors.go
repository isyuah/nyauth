...
var apiErrorCodesByMessage = map[string]string{
	...
	"failed to update login mfa requirement":                                             "mfa.login_requirement_update_failed",
	"login mfa updated; please sign in again":                                            "mfa.login_requirement_sign_in_required",
